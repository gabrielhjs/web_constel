...
def consulta_ont_detalhe(request, serial):
    ...
    aplicacoes = ont.aplicado_ont.values(
        ...
        cliente__contrato=ExpressionWrapper(F('cliente__contrato'), output_field=IntegerField()),
        cliente__nivel_ont=ExpressionWrapper(F('cliente__nivel_ont'), output_field=FloatField()),
    )
