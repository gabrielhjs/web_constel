    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data', models.DateTimeField(auto_now=True, verbose_name='Data de entrada')),
                ('status', models.IntegerField(choices=[(0, 'Estoque'), (1, 'Em uso')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entrada', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='entrada_saida', to='patrimonio1.PatrimonioEntrada', verbose_name='Patrimônio')),
